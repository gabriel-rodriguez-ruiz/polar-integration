...
file_to_open = data_folder / "superfluid_density_B_in_0.0_(0.8-2.5)_phi_x_in_(-0.002-0.002)_Delta=0.08_lambda=0.64_points=16_N_phi=101_N=200_C=3.npz"
...
axs[0].plot(B_values/Delta, superfluid_density_yy, "o", label=r"$D_{yy}(\phi_{x,eq}, \phi_y=0)$")
