...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 10 07:54:08 2025
...
axs[0].plot(B_values/Delta, superfluid_density_finite_differences_perpendicular, "v", label=r"$D_{s}(B_{\perp}, \textbf{q}_B^{eq})$",
            color="green")

# axs[0].plot(B_values/Delta, superfluid_density_0, "o", label=r"$\phi=0$")
axs[0].scatter(B_values/Delta, superfluid_density_finite_differences_perpendicular_0, label=r"$D_{s}(B_{\perp}, \textbf{q}_B=0)$",
...
axs[0].set_title(r"$\alpha_R k_F/\Delta=$" + f"{np.round(Lambda*k_F/Delta, 2)}")
                 # + f"; C={C}")
...
axs[1].set_ylabel(r"$q_B^{eq}/k_F$")

superfluid_density_yy = Data["superfluid_density_yy"]
axs[0].plot(B_values/Delta, superfluid_density_yy, "o", label=r"$D_{s}(B_{\parallel}, \mathbf{q}_B^{eq})$",
            color="blue")

superfluid_density_yy_0 = Data["superfluid_density_yy_0"]
axs[0].scatter(B_values/Delta, superfluid_density_yy_0, label=r"$D_{s}(B_{\parallel}, \mathbf{q}_B=0)$",
...
axs[0].legend(fontsize=7, loc="upper right", ncols=2)
