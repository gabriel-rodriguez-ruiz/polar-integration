...
N = 66  #100
N_phi = 11 #31  # it should be odd to include zero

cut_off = 1.1*k_F
phi_values = np.linspace(-0.003 * k_F, 0.003 * k_F, N_phi)

# Define the skewed Mexican hat function in 1D
def skewed_mexican_hat(x, B_x, B_y):
...
energy_phi = np.zeros_like(phi_values)
...
def objective_function(x):
    ...
    return skewed_mexican_hat(x[0], B_x, B_y)
